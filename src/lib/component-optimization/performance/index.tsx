 ...
 * For debugging and tracking component performance (development only)
 */

import React, { useRef, useEffect, ComponentType } from 'react';

/**
 * Performance monitor higher-order component
 * Logs render times in development mode
 */
 ...
 * Logs which props caused a re-render (development only)
 */
