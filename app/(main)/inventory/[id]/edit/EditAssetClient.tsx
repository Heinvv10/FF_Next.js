...
export function EditAssetClient({ asset, categories }: EditAssetClientProps) {
  ...
  const [formData, setFormData] = useState({
    ...
    warrantyEndDate: asset.warrantyEndDate ? String(asset.warrantyEndDate).split('T')[0] : '',
